class KFWeap_Shield extends KFWeap_ThrownBase;
...
var array<KFProj_Shield> DeployedCharges;
...
{
	local Projectile P;
	local KFProj_Shield Charge;

	P = super.ProjectileFire();

	Charge = KFProj_Shield( P );
	if( Charge != none )
	{
		if(SkinItemId > 0)
		{
...
function SetOriginalValuesFromPickup( KFWeapon PickedUpWeapon )
{
	...
	DeployedCharges = KFWeap_Shield(PickedUpWeapon).DeployedCharges;
	NumDeployedCharges = DeployedCharges.Length;
	bForceNetUpdate = true;
...
defaultproperties
{
	...
	// Content
	PackageKey="SpiderCoil KFWeap_C8"
	FirstPersonMeshName="Wep_1P_C8_MESH.Wep_1stP_C8_Rig"
	FirstPersonAnimSetNames(0)="Wep_1P_C4_ANIM.Wep_1P_C4_ANIM"
	PickupMeshName="WEP_3P_C8_MESH.Wep_C8_Pickup"
	AttachmentArchetypeName="WEP_C8_ARCH.Wep_C8_3P"
	...
	WeaponProjectiles(THROW_FIREMODE)=class'KFProj_Shield'
